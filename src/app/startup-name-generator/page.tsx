...
export default function StartupNameGeneratorPage() {
  return (
    <>
      <IndustryPageSchema name="Startup Name Generator" path="/startup-name-generator" description="AI-powered startup name generator with complete brand kits including logos, colors, taglines, and domain availability." faqItems={FAQ_ITEMS} />
      ...
      {/* Blog Links */}
      <IndustryBlogLinks industry="startup-name-generator" />
      {/* Internal Links */}
