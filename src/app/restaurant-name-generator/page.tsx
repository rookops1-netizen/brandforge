...
export default function RestaurantNameGeneratorPage() {
  return (
    <>
      <IndustryPageSchema name="Restaurant Name Generator" path="/restaurant-name-generator" description="AI-powered restaurant name generator with complete brand kits including logos, colors, taglines, and domain availability." faqItems={FAQ_ITEMS} />
