...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://brandforge.app/beauty-name-generator',
    siteName: 'BrandForge',
    type: 'website',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://brandforge.app/beauty-name-generator',
  },
...
export default function BeautyNameGeneratorPage() {
  return (
    <>
      <IndustryPageSchema name="Beauty Name Generator" path="/beauty-name-generator" description="AI-powered beauty name generator with complete brand kits including logos, colors, taglines, and domain availability." faqItems={FAQ_ITEMS} />
      ...
      {/* Blog Links */}
      <IndustryBlogLinks industry="beauty-name-generator" />
      {/* Internal Links */}
...
<Link href="/florist-name-generator" className="rounded-full border border-slate-200 px-4 py-2 text-sm text-slate-600 hover:border-pink-300 hover:text-pink-600 transition-colors">
