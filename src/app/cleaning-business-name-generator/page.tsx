...
export default function CleaningBusinessNameGeneratorPage() {
  return (
    <>
      <IndustryPageSchema name="Cleaning Business Name Generator" path="/cleaning-business-name-generator" description="AI-powered cleaning business name generator with complete brand kits including logos, colors, taglines, and domain availability." faqItems={FAQ_ITEMS} />
      ...
      {/* Blog Links */}
      <IndustryBlogLinks industry="cleaning-business-name-generator" />
      {/* Internal Links */}
