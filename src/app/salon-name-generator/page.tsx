...
export default function SalonNameGeneratorPage() {
  return (
    <>
      <IndustryPageSchema name="Salon Name Generator" path="/salon-name-generator" description="AI-powered salon name generator with complete brand kits including logos, colors, taglines, and domain availability." faqItems={FAQ_ITEMS} />
