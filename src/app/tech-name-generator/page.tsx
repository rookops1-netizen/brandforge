...
export default function TechNameGeneratorPage() {
  return (
    <>
      <IndustryPageSchema name="Tech Name Generator" path="/tech-name-generator" description="AI-powered tech name generator with complete brand kits including logos, colors, taglines, and domain availability." faqItems={FAQ_ITEMS} />
      ...
      {/* Blog Links */}
      <IndustryBlogLinks industry="tech-name-generator" />
      {/* Internal Links */}
