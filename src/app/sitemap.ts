...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    // Blog articles — August 9
    {
      url: `${BASE_URL}/blog/cleaning-business-name-generator`,
      lastModified: new Date('2026-08-09'),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${BASE_URL}/blog/photography-brand-name-generator`,
      lastModified: new Date('2026-08-09'),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${BASE_URL}/blog/salon-brand-name-generator`,
      lastModified: new Date('2026-08-10'),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${BASE_URL}/blog/construction-brand-name-generator`,
    ...
    {
      url: `${BASE_URL}/blog/coffee-brand-name-generator`,
    ...
    {
      url: `${BASE_URL}/blog/domain-name-generator`,
      lastModified: new Date('2026-08-19'),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${BASE_URL}/blog/florist-name-generator`,
      lastModified: new Date('2026-08-19'),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${BASE_URL}/blog/beauty-name-generator`,
      lastModified: new Date('2026-08-21'),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${BASE_URL}/blog/food-truck-name-generator`,
