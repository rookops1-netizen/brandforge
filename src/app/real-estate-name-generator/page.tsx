...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://brandforge.app/real-estate-name-generator',
    siteName: 'BrandForge',
    type: 'website',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://brandforge.app/real-estate-name-generator',
  },
...
export default function RealEstateNameGeneratorPage() {
  return (
    <>
      <IndustryPageSchema name="Real Estate Name Generator" path="/real-estate-name-generator" description="AI-powered real estate name generator with complete brand kits including logos, colors, taglines, and domain availability." faqItems={FAQ_ITEMS} />
