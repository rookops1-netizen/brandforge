...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://brandforge.app/coaching-name-generator',
    siteName: 'BrandForge',
    type: 'website',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://brandforge.app/coaching-name-generator',
  },
...
export default function CoachingNameGeneratorPage() {
  return (
    <>
      <IndustryPageSchema name="Coaching Name Generator" path="/coaching-name-generator" description="AI-powered coaching name generator with complete brand kits including logos, colors, taglines, and domain availability." faqItems={FAQ_ITEMS} />
      ...
      {/* Blog Links */}
      <IndustryBlogLinks industry="coaching-name-generator" />
      {/* Internal Links */}
