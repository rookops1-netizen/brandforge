...
export default function FitnessBrandNameGeneratorPage() {
  return (
    <>
      <IndustryPageSchema name="Fitness Brand Name Generator" path="/fitness-brand-name-generator" description="AI-powered fitness brand name generator with complete brand kits including logos, colors, taglines, and domain availability." faqItems={FAQ_ITEMS} />
      ...
      {/* Blog Links */}
      <IndustryBlogLinks industry="fitness-brand-name-generator" />
      {/* Internal Links */}
