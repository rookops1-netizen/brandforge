...
export default function LandscapingNameGeneratorPage() {
  return (
    <>
      <IndustryPageSchema name="Landscaping Name Generator" path="/landscaping-name-generator" description="AI-powered landscaping name generator with complete brand kits including logos, colors, taglines, and domain availability." faqItems={FAQ_ITEMS} />
      ...
      {/* Blog Links */}
      <IndustryBlogLinks industry="landscaping-name-generator" />
      {/* Internal Links */}
