...
export default function PodcastNameGeneratorPage() {
  return (
    <>
      <IndustryPageSchema name="Podcast Name Generator" path="/podcast-name-generator" description="AI-powered podcast name generator with complete brand kits including logos, colors, taglines, and domain availability." faqItems={FAQ_ITEMS} />
      ...
      {/* Blog Links */}
      <IndustryBlogLinks industry="podcast-name-generator" />
      {/* Internal Links */}
