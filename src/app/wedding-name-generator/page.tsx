...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://brandforge.app/wedding-name-generator',
    siteName: 'BrandForge',
    type: 'website',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://brandforge.app/wedding-name-generator',
  },
...
export default function WeddingNameGeneratorPage() {
  const ALL_LINKS = [
    ...
    { href: '/catering-name-generator', emoji: '🍽️', label: 'Catering Name Generator' },
  ...
  return (
    <>
      ...
      {/* Blog Links */}
      <IndustryBlogLinks industry="wedding-name-generator" />
      {/* Internal Links */}
