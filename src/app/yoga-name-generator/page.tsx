...
export default function YogaNameGeneratorPage() {
  return (
    <>
      <IndustryPageSchema name="Yoga Name Generator" path="/yoga-name-generator" description="AI-powered yoga name generator with complete brand kits including logos, colors, taglines, and domain availability." faqItems={FAQ_ITEMS} />
