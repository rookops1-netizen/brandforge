...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://brandforge.app/coffee-name-generator',
    siteName: 'BrandForge',
    type: 'website',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://brandforge.app/coffee-name-generator',
  },
...
export default function CoffeeNameGeneratorPage() {
  return (
    <>
      <IndustryPageSchema name="Coffee Name Generator" path="/coffee-name-generator" description="AI-powered coffee name generator with complete brand kits including logos, colors, taglines, and domain availability." faqItems={FAQ_ITEMS} />
      ...
      {/* Blog Links */}
      <IndustryBlogLinks industry="coffee-name-generator" />
      {/* Internal Links */}
