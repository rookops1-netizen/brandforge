...
export default function FoodTruckNameGeneratorPage() {
  return (
    <>
      <IndustryPageSchema name="Food Truck Name Generator" path="/food-truck-name-generator" description="AI-powered food truck name generator with complete brand kits including logos, colors, taglines, and domain availability." faqItems={FAQ_ITEMS} />
      ...
      {/* Blog Links */}
      <IndustryBlogLinks industry="food-truck-name-generator" />
      {/* Internal Links */}
