...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://brandforge.app/pet-name-generator',
    siteName: 'BrandForge',
    type: 'website',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://brandforge.app/pet-name-generator',
  },
...
export default function PetNameGeneratorPage() {
  return (
    <>
      <IndustryPageSchema name="Pet Name Generator" path="/pet-name-generator" description="AI-powered pet business name generator with complete brand kits including logos, colors, taglines, and domain availability." faqItems={FAQ_ITEMS} />
      ...
      {/* Blog Links */}
      <IndustryBlogLinks industry="pet-name-generator" />
      {/* Internal Links */}
