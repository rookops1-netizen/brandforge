    ...
    <article className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <section className="mt-16 border-t border-slate-200 pt-10">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Link href="/blog/tagline-writing-guide" className="group rounded-xl border border-slate-200 bg-white p-5 hover:border-brand-200 hover:shadow-md transition-all">
            <h4 className="font-semibold text-slate-900 group-hover:text-brand-600 transition-colors">Tagline Writing Guide: How to Write a Tagline That Sells</h4>
            <p className="mt-1 text-sm text-slate-500">Craft a tagline that captures your brand&apos;s essence — with real examples and a step-by-step process.</p>
          </Link>
          <Link href="/blog/how-to-build-brand-identity" className="group rounded-xl border border-slate-200 bg-white p-5 hover:border-brand-200 hover:shadow-md transition-all">
            <h4 className="font-semibold text-slate-900 group-hover:text-brand-600 transition-colors">How to Build a Brand Identity from Scratch</h4>
            <p className="mt-1 text-sm text-slate-500">The complete guide to building a brand identity — from name and colors to logo and tagline.</p>
          </Link>
