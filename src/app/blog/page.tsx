...
const blogPosts = [
  ...
  {
    slug: 'salon-brand-name-generator',
    title: 'Salon Name Generator: 300+ Salon Name Ideas for 2026 + Free AI Tool',
    excerpt: '300+ salon name ideas across 10 categories, 7 naming strategies from top salons, and a free AI generator that checks domain & social availability.',
    category: 'Naming',
    readTime: '15 min',
    date: '2026-08-10',
    featured: false,
  ...
  },
  {
    ...
    excerpt: '300+ food truck name ideas across 10 categories, 7 naming strategies from top food truck brands, and a free AI generator that checks domain & social availability instantly.',
    category: 'Naming',
    readTime: '15 min',
    date: '2026-08-23',
    featured: false,
