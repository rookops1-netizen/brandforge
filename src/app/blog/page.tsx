...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt: '300+ coffee shop and café name ideas across 10 categories, 7 naming strategies from top coffee brands, and a free AI generator that checks domain & social availability.',
    category: 'Naming',
    readTime: '16 min',
    date: '2026-08-14',
    featured: true,
