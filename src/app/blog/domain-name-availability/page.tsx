...
const FAQ_ITEMS = [
  {
    ...
    answer: 'Search your desired name at any domain registrar (Namecheap, Google Domains, GoDaddy) — they\'ll instantly show availability for .com and other TLDs. For faster bulk checking, use tools like BrandForge\'s built-in domain checker, which automatically checks availability for every name it generates, or DomainTyper for real-time checking across multiple TLDs.',
  },
  {
    question: 'What should I do if the .com domain is taken?',
    answer: 'You have four options: (1) Add a modifier — get[name].com, [name]app.com, or try[name].com (many successful startups launched this way). (2) Use an alternative TLD — .io for tech, .co for companies, .ai for AI products. (3) Buy the .com — if it\'s parked, negotiate with the owner (often $500-$5,000). (4) Modify the name — adding one letter (Figma, Notion) can unlock the .com.',
  },
  {
    question: 'Are alternative TLDs like .io and .co professional enough?',
    answer: 'Yes — the stigma around non-.com domains has largely disappeared. .io is standard for tech startups (GitHub.io, Notion.io), .co works for companies, .ai is accepted for AI products, and .app/.dev are normal for software. For consumer brands, .com still matters most, but for B2B and tech, alternative TLDs are completely professional.',
  },
  {
    question: 'How much does a domain name cost?',
    answer: 'A new .com registration costs $8-15/year from registrars like Namecheap or Google Domains. Alternative TLDs range from $10/year (.co) to $70+/year (.ai). If you\'re buying a parked domain from someone else, prices range from $500 to $50,000+ depending on the name\'s desirability. Budget $10-15/year for a standard registration.',
  },
  {
    question: 'Should I buy multiple domain extensions for my business name?',
    answer: 'It\'s a smart move for brand protection. At minimum, register the .com and your primary alternative TLD. If you\'re serious about protecting your brand, also grab common typos and the .net, .org, and .co variations. This prevents competitors or squatters from registering similar domains and protects your brand identity.',
  },
  {
    question: 'Can BrandForge check domain availability?',
    answer: 'Yes! Every name generated by BrandForge comes with real-time domain availability checks across .com, .io, .co, and other popular TLDs. No more switching tabs to a domain registrar — you see what\'s available the moment you see a name you like. It\'s free to use with unlimited generations.',
  },
  {
    question: 'What makes a good domain name?',
    answer: 'A good domain name is: (1) Short — ideally 6-10 characters. (2) Easy to spell — if you have to spell it out on a podcast, it\'s too complicated. (3) Memorable — people should remember it after hearing it once. (4) .com preferred — it\'s still the default. (5) No hyphens or numbers — these look unprofessional and are hard to communicate verbally.',
  },
  {
    question: 'How do I buy a domain that\'s already taken?',
    answer: 'If the .com is parked (no active website), find the owner through WHOIS lookup or domain brokers like Sedo. Reach out with a reasonable offer — parked domains often sell for $500-$5,000. If there\'s a "Make Offer" button on a parking page, use it. Never lowball — start at 30-50% of what you\'re actually willing to pay.',
  },
]
