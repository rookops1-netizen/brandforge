...
const FAQ_ITEMS = [
  {
    question: 'What is a brand name generator?',
    answer: 'A brand name generator is a tool that creates business name ideas based on your brand description, industry, or keywords. AI-powered generators like BrandForge analyze your input to produce context-aware names, then automatically check domain and social media availability for each suggestion.',
  },
  {
    question: 'How does an AI brand name generator work?',
    answer: 'AI brand name generators use large language models trained on naming patterns from successful brands. You describe your business, target audience, and desired vibe, and the AI generates dozens of name options using techniques like word combinations, metaphors, invented words, and foreign language roots — the same patterns behind names like Netflix, Amazon, and Nike.',
  },
  {
    question: 'Are brand name generators free?',
    answer: 'BrandForge\'s name generator is free to use — you get unlimited name ideas with domain availability checks at no cost. A complete brand kit including logo concepts, color palette, tagline, and font pairings is available for $9. Some other generators require subscriptions or have limited free tiers.',
  },
  {
    question: 'What are the 7 naming styles for brand names?',
    answer: 'The 7 proven naming styles are: (1) Invented words — made-up names like Google and Kodak, (2) Compound words — two words combined like Netflix and Facebook, (3) Metaphorical — names evoking imagery like Amazon and Patagonia, (4) Founder names — named after people like Nike and Ben & Jerry\'s, (5) Acronyms — letters representing longer names like IBM and KFC, (6) Real words — dictionary words repurposed like Apple and Slack, and (7) Foreign words — words from other languages like Häagen-Dazs and Kia.',
  },
  {
    question: 'How do I validate a brand name?',
    answer: 'Validate your brand name with an 8-point checklist: (1) Is it under 10 characters? (2) Can someone spell it after hearing it once? (3) Is the .com domain available? (4) Are social media handles available? (5) Does a USPTO trademark search come back clean? (6) Is it distinct from competitors? (7) Does it feel right for your brand personality? (8) Would you be proud to say it in a crowded room? BrandForge automates checks 3-5 for you.',
  },
  {
    question: 'What makes a brand name generator better than brainstorming?',
    answer: 'Speed, volume, and unexpected ideas. A good AI generator produces 50+ name options in seconds, many of which you\'d never think of through brainstorming alone. It combines patterns from successful brands with your specific business context. However, the best approach is using both — generate with AI, then apply human judgment to pick the winner.',
  },
  {
    question: 'Can I trademark a name generated by an AI tool?',
    answer: 'Yes. Names generated by AI tools like BrandForge are original creations — they don\'t copy existing trademarks. However, you should always do a proper trademark search before committing, as similar names may exist independently. File a trademark application once you\'ve confirmed availability. The name must be distinctive enough to function as a source identifier.',
  },
  {
    question: 'How many brand name ideas should I generate?',
    answer: 'Generate at least 50-100 name ideas before you start filtering. Most people stop too early and miss better options. Run a brand name generator 5-10 times with different descriptions and keywords, brainstorm with different techniques, and build a long list first. Then filter down to a shortlist of 5-7 names for validation and testing.',
  },
]
      ...
      <section className="mb-16 border-t border-slate-200 pt-10">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <Link href="/blog/brand-naming-guide" className="group rounded-xl border border-slate-200 bg-white p-5 hover:border-brand-200 hover:shadow-md transition-all">
            ...
            <p className="mt-1 text-sm text-slate-500">12 practical tips for a brand name that sticks — with real examples from Stripe, Airbnb, and Notion.</p>
          </Link>
        </div>
      </section>
