...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'View your complete brand kit with logo concepts, color palettes, taglines, and domain/social availability.',
    url: 'https://brandforge.app/brand-kit',
    siteName: 'BrandForge',
    type: 'website',
  },
  robots: { index: true, follow: true },
  alternates: { canonical: 'https://brandforge.app/brand-kit' },
}
            ...
            '@graph': [
              ...
              },
              {
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 2, name: 'Brand Kit', item: 'https://brandforge.app/brand-kit' },
                ],
              },
              {
