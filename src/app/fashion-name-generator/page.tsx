...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://brandforge.app/fashion-name-generator',
    siteName: 'BrandForge',
    type: 'website',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://brandforge.app/fashion-name-generator',
  },
...
export default function FashionNameGeneratorPage() {
  return (
    <>
      <IndustryPageSchema name="Fashion Name Generator" path="/fashion-name-generator" description="AI-powered fashion name generator with complete brand kits including logos, colors, taglines, and domain availability." faqItems={FAQ_ITEMS} />
