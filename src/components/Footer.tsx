      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 border-t border-slate-200 pt-6 flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex items-center gap-5">
            <a href="https://twitter.com/brandforge" className="text-slate-400 hover:text-brand-600 transition-colors" aria-label="Twitter">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </a>
            <a href="https://github.com/brandforge" className="text-slate-400 hover:text-brand-600 transition-colors" aria-label="GitHub">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://linkedin.com/company/brandforge" className="text-slate-400 hover:text-brand-600 transition-colors" aria-label="LinkedIn">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
