...
export function JsonLd() {
  ...
  const softwareApp = {
    ...
    review: [
      ...
      {
        '@type': 'Review',
        name: 'Professional and trustworthy name for my business',
        reviewBody: 'Got a name that sounds professional and trustworthy — exactly what cleaning clients need to see on Google Maps.',
      ...
      {
        '@type': 'Review',
        name: 'The name became part of our brand identity',
        reviewBody: 'My clients always comment on the name. It\'s become part of our brand identity — warm, premium, and memorable.',
        datePublished: '2026-02-15',
        author: { '@type': 'Person', name: 'Amanda Liu' },
        reviewRating: { '@type': 'Rating', ratingValue: '5', bestRating: '5', worstRating: '1' },
      },
    ],
  }
